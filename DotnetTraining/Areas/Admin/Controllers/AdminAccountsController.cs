...
namespace DotnetTraining.Areas.Admin.Controllers
{
    ...
    public class AdminAccountsController : Controller
    {
        ...
        public AdminAccountsController(dbEcommerceRookiesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var dbEcommerceRookiesContext = _context.Accounts.Include(a => a.Role);
            return View(await dbEcommerceRookiesContext.ToListAsync());
        }
