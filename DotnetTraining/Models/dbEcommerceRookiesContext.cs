...
{
    public partial class dbEcommerceRookiesContext : DbContext
    {
        public dbEcommerceRookiesContext()
        {
        }

        public dbEcommerceRookiesContext(DbContextOptions<dbEcommerceRookiesContext> options)
            : base(options)
        {
        }
